...
#######################################################################
# Model
pretrained_model_name_or_path = '/home/ma-user/local_cache/Qwen/Qwen3-8B'
...
data_path = [
    '/sfs/liuqi/data/AI-MO/NuminaMath-1.5/cycle123_problem_generation_steps.jsonl'
]
