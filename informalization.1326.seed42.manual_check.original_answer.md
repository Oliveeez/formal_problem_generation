...
### Informal Answer
The sum \( x^{n + 2m} + y^{n + 2m} + z^{n + 2m} \) is greater than 30000.
...
### Informal Answer
The only possible pairs are \( (1, -2) \) and \( \left(-\frac{1}{2}, -\frac{1}{2}\right) \).
...
### Informal Answer
\[
\cos^2 \theta = \left( \frac{14}{\sqrt{14^2 + (-30)^2}} \right)^2, \quad \sin^2 \theta = \left( \frac{-30}{\sqrt{14^2 + (-30)^2}} \right)^2
\]
